...
| Specification version | `1.0.0-draft.3` |
...
- `acceptance_criterion` — the canonical falsifiable behavioral proposition by which satisfaction or violation of this requirement can be determined;
...
draft.1; thirty-six in draft.2; thirty-seven in draft.3). An artifact can pass every individual local rule and
...
acceptance_criterion: given a stale policy_sha256, the verifier returns refused_stale_policy and emits no accepted transition
