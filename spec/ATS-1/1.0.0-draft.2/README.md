...
This directory contains the repo-ready normative package for **ATS-1: Arq Text Standard**, version `1.0.0-draft.2`.

## Contents

- `ATS-1_SPEC.md` — the normative specification.
- `rules/ats_rules_v2.yaml` — the 36-rule draft.2 registry.
