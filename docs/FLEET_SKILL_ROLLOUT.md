...
| ATS skill pack | `skill_pack_version` | `0.1.2` | the public skill surface + packaging |
...
Release `0.1.2` is published from the history-free public repository under the
signed annotated tag `v0.1.2-skill-pack`; release `0.1.1` remains available as
the previous release. Vendoring instructions never create or move release tags.
...
(`0.1.2`), `implementation_version` (`0.5.0`), `standard_versions_supported`
