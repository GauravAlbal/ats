...
This checkout carries the released `0.1.1` skill pack. Canonical source comes
first: update the public skills and recipes, then generate and verify the host
forms; do not hand-edit `dist/skill-pack/`.
