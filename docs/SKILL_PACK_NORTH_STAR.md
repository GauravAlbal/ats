...
| ATS skill pack | `0.1.1` candidate | The public skill surface and its packaging. |
...
`v0.1.1-skill-pack`. Canonical source comes first: complete the public skills
and recipes, generate the host forms, and verify their manifest.
