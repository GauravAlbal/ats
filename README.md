...
| ATS skill pack | `0.1.2` | Released portable recipe lookup repair for the public skill surface |
...
The current public skill-pack release is `0.1.2` (`SKILL_PACK_VERSION`) under
the signed annotated tag `v0.1.2-skill-pack`; release `0.1.1` remains available
as the previous release. Canonical source comes first: update `skills/public/**`
